...
float spd[4] = { 30, 50, 10, 9 };
float dis[5] = { 0.59, 0.79, 0.99, 1.2, 0.1 };
float rad[6] = { 0.2, 0.1, 0.09, 0.04, 0.07, 0.02 };
bool isDragging = false;

//Color for planets and rings
float color1[3] = { 0.5f, 0.0f, 1.0f };
float color2[3] = { 1.0f, 0.0f, 0.0f };
float color3[3] = { 0.0f, 1.0f, 1.0f };
float color4[3] = { 1.0f, 1.0f, 1.0f };
float color5[3] = { 0.0f, 0.0f, 1.0f };
...
void render(void)
{
  ...
  for (float angle = 0; angle <= 2 * PI * 100; angle += 0.1)
  {
    ...
    glColor3f(palette[ring][0], palette[ring][1], palette[ring][2]);
    glVertex3f(x, y, z);
  ...
  glColor3f(color1[0], color1[1], color1[2]);           //purple planet 1
  ...
  glColor3f(color2[0], color2[1], color2[2]);         //red planet 2
  ...
  glRotatef(g_Theta*spd[2], 0, 1, 0);
  glColor3f(color3[0], color3[1], color3[2]);         //cyan planet 3
  ...
  glRotatef(20, 0, 1, 0);
  glColor3f(color4[0], color4[1], color4[2]);         //white planet 4
  ...
  glRotatef(g_Theta*spd[3], 0, 1, 0);
  glColor3f(color5[0], color5[1], color5[2]);         //blue moon
